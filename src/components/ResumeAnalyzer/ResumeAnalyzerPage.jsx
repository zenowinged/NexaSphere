...
const MOCK_RESULT = {
  ...
  recommendations: [
    { icon: "🗺️", type: "roadmap", title: "Full Stack Developer Roadmap",
      description: "You're 65% aligned. Strengthen Node.js and System Design to close the gap.",
      link: "/roadmaps" },
    { icon: "📘", type: "course", title: "TypeScript for React Developers",
      description: "Highly in-demand skill missing from your profile. Add it in 2–3 weeks.",
      link: "https://www.typescriptlang.org/docs/" },
    { icon: "🏗️", type: "project", title: "Build a Full-Stack Dashboard",
      description: "Showcases React, Node.js, and TypeScript together — perfect for your portfolio.",
      link: "/projects" },
    { icon: "🏆", type: "certification", title: "AWS Cloud Practitioner",
...
export default function ResumeAnalyzerPage() {
  ...
  const handleUpload = () => {
    setStep("analyzing");
    setTimeout(() => { setResult(MOCK_RESULT); setStep("result"); }, 2500);
  };
    ...
    <div className="ra-page">
      ...
      {step === "analyzing" && (
        <div className="ra-analyzing">
          ...
          <p className="analyzing-sub">Extracting skills · Detecting gaps · Generating recommendations</p>
        </div>
      )}
